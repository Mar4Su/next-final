...
HD_PWD='C:/Users/user/Desktop/finalprojmara/next final/next final.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log random_number_display.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source random_number_display.tcl
