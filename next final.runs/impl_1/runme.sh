...
HD_PWD='C:/Users/user/Desktop/finalprojmara/next final/next final.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log random_number_display.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source random_number_display.tcl -notrace
